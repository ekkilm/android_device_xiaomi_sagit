...
PRODUCT_BUILD_PROP_OVERRIDES += \
    TARGET_DEVICE="sagit" \
    PRODUCT_NAME="sagit" \
    BUILD_FINGERPRINT="Xiaomi/sagit/sagit:7.1.1/NMF26X/V8.5.1.0.NCAMIEG:user/release-keys" \
    PRIVATE_BUILD_DESC="sagit-user 7.1.1 NMF26X V8.5.1.0.NCAMIEG release-keys"
